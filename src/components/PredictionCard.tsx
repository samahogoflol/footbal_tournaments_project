...
export const PredictionCard = ({item} : PredictionCardProps) => {
    return (
                        ...
                        <>
                          ...
                          <div className="flex flex-col items-center w-12">
                            ...
                            <span className={`font-black text-sm px-2 py-1 rounded-md w-full text-center ${
                              item.points_awarded === 3 ? 'bg-green-500/20 text-green-400 border border-green-500/30' :
                              item.points_awarded === 1 ? 'bg-yellow-500/20 text-yellow-400 border border-yellow-500/30' :
